...
export default function ProductForm({ open, onClose, onSaved }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Only include optional fields if they have a value, to avoid errors
      // when columns haven't been added to the table yet.
